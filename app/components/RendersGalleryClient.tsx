...
type RendersGalleryClientProps = {
  images: RenderImage[];
};
...
export default function RendersGalleryClient({ images }: RendersGalleryClientProps) {
  ...
  if (images.length === 0) {
    return <p style={{ color: "var(--text-secondary)" }}>No hay renders disponibles.</p>;
  }
